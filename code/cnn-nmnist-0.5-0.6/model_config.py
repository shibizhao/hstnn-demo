...
base_config = [
    {"input_channels": 2,   "cnn_channels": 128, "conv_kernel_size": 3, "pool_kernel_size": 2, "conv_stride": 1, "pool_stride": 2, "fc_padding": 0, "fv_padding": 1, "avr_pool": True},
...
linear_config = [
    ...
    {"input_channels": 256, "output_channels": 10},
]