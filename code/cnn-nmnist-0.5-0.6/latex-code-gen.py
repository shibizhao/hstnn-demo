...
seed_list = [2222, 3333, 4444]
snn_ratio = [0.05, 0.15, 0.25, 0.35, 0.45, 0.5, 0.55, 0.65, 0.75, 0.85, 0.95]
...
def extract_one_performance(model, seed, ratio=None):
    if model == "rnn" or model == "lstm" or model == "snn":
        file_name = "test" + "_" + dataset + "_" + model + "_" + str(seed) + ".log"
    else:
        assert model == "ffs" or model == "hybrid"
        file_name = "test" + "_" + dataset + "_" + model + "_" + str(seed) + "_" + str(ratio) + ".log"
...
csv_str_ffs = "type, 2222, 3333, 4444, avg, squ\n"

csv_str_hybrid = "type, 2222, 3333, 4444, avg, squ\n"
...
\hline \n\
      & \multicolumn{2}{c|}{2222}  & \multicolumn{2}{c|}{3333}  & \multicolumn{2}{c|}{4444}  \\\ \hline \n"
